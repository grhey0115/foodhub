function calculate_item_price(description, size) {
    const pricing_logic = {
    ...
    return pricing_logic[description][size];
}
...
function calculateTotalPrice() {
    ...
    const pricePerItem = calculate_item_price(desc, size); // Call the new function
